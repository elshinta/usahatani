...
public class PeriodeTransaksiPenerimaan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_periode,new TampilPeriodePenerimaanFragment()).commit();
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            ...
            case R.id.radioTambahPeriode:
                if (checked)
                    getSupportFragmentManager().beginTransaction().replace(R.id.fragment_periode, new TambahPeriodePenerimaanFragment()).commit();
