...
public class TambahPeriodePengeluaranFragment extends Fragment {
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                if(insert_periode){
                                    ...
                                    fr.replace(R.id.fragment_periode, new TampilPeriodePengeluaranFragment());
                                    fr.commit();
                                    PeriodeTransaksiPengeluaran p1 = (PeriodeTransaksiPengeluaran)getActivity();
                                    p1.setRadio(true);
                                }
                                else{
